...
mixin _$Course {
  ...
  List<String> get trainees => throw _privateConstructorUsedError;
  @TimestampConverter()
...
class _$CourseImpl extends _Course {
  const _$CourseImpl({
    ...
    final List<String> trainees = const [],
  ...
  @override
  String toString() {
    return 'Course(id: $id, name: $name, trainerId: $trainerId, courseCode: $courseCode, trainees: $trainees, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
    ...
    trainerId,
    courseCode,
    const DeepCollectionEquality().hash(_trainees),
    createdAt,
  );
